        ...
        <div className="prose prose-blue max-w-none">
          ...
          <div className="mb-12">
            ...
            <div className="bg-gradient-to-r from-pink-50 to-rose-100 rounded-xl p-6 border border-pink-200">
              <p className="text-gray-700 mb-4">{t('calendar.description')}</p>
              <ul className="space-y-2 text-gray-700 mb-4">
                <li className="flex items-start gap-2">
                  <span>🎉</span>
                  <span>{t('calendar.point1')}</span>
                </li>
                <li className="flex items-start gap-2">
                  <span>✅</span>
                  <span>{t('calendar.point2')}</span>
                </li>
                <li className="flex items-start gap-2">
                  <span>🔔</span>
                  <span>{t('calendar.point3')}</span>
                </li>
              </ul>
              <Link
                href={`/${locale}/dorm-calendar`}
                className="inline-flex items-center gap-2 bg-pink-600 text-white px-5 py-2.5 rounded-lg hover:bg-pink-700 transition-colors font-semibold"
              >
                <span>📅</span>
                View Dorm Calendar
              </Link>
          ...
          <div className="mb-12">
            ...
            <div className="bg-gradient-to-r from-amber-50 to-yellow-100 rounded-xl p-6 border border-amber-200">
              <p className="text-gray-700 mb-4">{t('cs24.description')}</p>
              <ul className="space-y-2 text-gray-700 mb-4">
                <li className="flex items-start gap-2">
                  <span>✓</span>
                  <span>{t('cs24.point1')}</span>
                </li>
                <li className="flex items-start gap-2">
                  <span>✓</span>
                  <span>{t('cs24.point2')}</span>
                </li>
                <li className="flex items-start gap-2">
                  <span>✓</span>
                  <span>{t('cs24.point3')}</span>
                </li>
              </ul>
              <div className="flex flex-wrap items-center gap-4">
                <a
                  href="https://cs24.co.il"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 bg-amber-600 text-white px-5 py-2.5 rounded-lg hover:bg-amber-700 transition-colors font-semibold"
                >
                  <span>🚀</span>
                  Visit CS24
                </a>
                <a
                  href={t('cs24.creditLink')}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 text-green-600 hover:text-green-700 font-semibold underline text-sm"
                >
                  <span>👨‍💻</span>
                  <span>{t('cs24.credit')}</span>
                </a>
              </div>
            </div>
          </div>
